...
DROP TRIGGER IF EXISTS prevent_workspace_lockout ON public.tenant_members;
CREATE TRIGGER prevent_workspace_lockout
BEFORE UPDATE OR DELETE ON public.tenant_members
FOR EACH ROW
EXECUTE FUNCTION public.prevent_workspace_lockout();
